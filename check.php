...
$sql = 'SELECT gdata.u_id,gdata.id,gdata.gname,gdata.itidaseki,gdata.nidaseki,gdata.sandaseki,gdata.yondaseki,gdata.comment FROM gdata JOIN userDeta ON userDeta.id = gdata.u_id';
	$stmt = $pdo->query($sql);
